...
public class ASSearch extends SearchMethod {

    public ArrayList<Location> blockedLocations;
    public int[] boundaryXY;  // max x and y

    public ASSearch(Location startLocation, Location goalLocation, int[] boundaryXY, ArrayList<Location> blockedLocations){
        this.code = "A*";
            ...
            if ( thisLocation.equals(goalLocation) ){
                ...
                for(int i = 0; i < newLocationList.size(); i++)
                {
                    ...
                    if( addToFrontier( newChild ) ) {
                        ...
                        // evaluate function is equal to its cost path plus heuristic value
                        newChild.evaluationFunction = newChild.cost + newChild.heuristicValue;
                    }
                }
